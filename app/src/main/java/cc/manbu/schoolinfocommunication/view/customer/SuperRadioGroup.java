...
/**
 * 拓展RadioGroup，实现RadioButton外可以嵌套多层容器
 *
...
public class SuperRadioGroup extends LinearLayout {
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        if (child instanceof RadioButton) {
            ...
            final List<RadioButton> list = findRadioButton((ViewGroup) child);
    ...
    public List<RadioButton> findRadioButton(ViewGroup group) {
        ...
        for (int i = 0; i < len; i++) {
            if (group.getChildAt(i) instanceof RadioButton) {
                ...
                List<RadioButton> list1 = findRadioButton((ViewGroup) group.getChildAt(i));
                list.addAll(list1);
            }
        }
        return list;
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == SuperRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == SuperRadioGroup.this
                    && child instanceof ViewGroup) {
                List<RadioButton> list = findRadioButton((ViewGroup) child);
