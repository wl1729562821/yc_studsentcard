...
public class JsonCollectionsOfDayOffResonseParser implements ResponseParser {
    @Override
    ...
    public Object parse(Type resultType, Class<?> resultClass, String result) throws Throwable {
        LogUtil.e("JsonCollectionsOfDayOffResonseParser===="+result);
        ...
        return JSONHelper.parseCollection(jArray, ArrayList.class, Sleave.class);
    }
}
