...
public class JsonCollectionsOfHomeWorkResonseParser implements ResponseParser {
    @Override
    ...
    public Object parse(Type resultType, Class<?> resultClass, String result) throws Throwable {
        LogUtil.e("JsonCollectionsOfHomeWorkResonseParser===="+result);
        ...
        return JSONHelper.parseCollection(jArray, ArrayList.class, Hw_Homework.class);
    }
}
