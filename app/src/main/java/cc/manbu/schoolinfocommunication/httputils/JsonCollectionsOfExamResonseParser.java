...
public class JsonCollectionsOfExamResonseParser implements ResponseParser {
    @Override
    ...
    public Object parse(Type resultType, Class<?> resultClass, String result) throws Throwable {
        LogUtil.e("JsonCollectionsOfExamResonseParser===="+result);
        ...
        return JSONHelper.parseCollection(jArray, ArrayList.class, SR_Exam.class);
    }
}
