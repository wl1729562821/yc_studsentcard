...
public class JsonCollectionsOfGeographyResonseParser implements ResponseParser {
    @Override
    ...
    public Object parse(Type resultType, Class<?> resultClass, String result) throws Throwable {
        LogUtil.e("JsonCollectionsOfGeographyResonseParser===="+result);
        ...
        return JSONHelper.parseCollection(jArray, ArrayList.class, Device_Geography.class);
    }
}
